...
// RequireConfirmedAccount = false: al registrarse se inicia sesión automáticamente
// (no hay servicio de correo y no tiene sentido pedir un login extra tras el alta).
